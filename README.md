...
## 🛠️ Skills & Tech Stack (Animated Icons Section)
...
- 🏗️ **AWS 3-Tier E-Commerce Infra** – EC2 + RDS + ALB + Terraform  
- ⚙️ **Jenkins CI/CD Pipeline** – Build → Test → Deploy to EC2  
- ☁️ **Serverless File Upload App** – S3 + Lambda + API Gateway  
